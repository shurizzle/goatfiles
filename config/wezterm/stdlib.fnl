...
(gfn count [xs]
  ...
  (if
    (table? xs) (accumulate [c 0 _ _ (pairs xs)] (inc c))
    (not xs) 0
    (length xs)))
...
(gfn once [f]
  (assert (function? f) (.. "Expected function, got " (type f)))
  (var called false)
  (fn [...]
    (when (not called)
      (set called true)
